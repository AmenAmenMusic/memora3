...
class RequetesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requete" do
    assert_difference('Requete.count') do
      post requetes_url, params: { requete: { etudiant_id: @requete.etudiant_id, maitre_id: @requete.maitre_id, status: @requete.status } }
    end
  ...
  test "should update requete" do
    patch requete_url(@requete), params: { requete: { etudiant_id: @requete.etudiant_id, maitre_id: @requete.maitre_id, status: @requete.status } }
